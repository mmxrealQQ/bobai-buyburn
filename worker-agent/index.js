...
<p class="note">Same facts as JSON: <a href="/job?id=${h(id)}&amp;format=json">/job?id=${h(id)}&amp;format=json</a> · <a href="https://brainonbnb.com/registry">Brain Plaza</a></p>
    ...
    if (path === '/sessions') {
      ...
      if (wantsHtml) {
        ...
        const html = `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>What has actually been asked — Brain Plaza</title><link rel="icon" href="https://brainonbnb.com/favicon.png">
<style>
:root{color-scheme:dark}body{margin:0;background:#0c0b0c;color:#f3efe6;font:15px/1.6 Inter,system-ui,sans-serif}
main{max-width:960px;margin:0 auto;padding:28px 18px 60px}h1{font-size:1.5rem;margin:0 0 4px}h2{font-size:1rem;margin:26px 0 8px;color:#f0b90b}
p.means{color:#cfc9bd;margin:6px 0 0}a{color:#f0b90b}code{font-size:.85em}.note{color:#a9a49a;font-size:.82rem;margin-top:10px}
...
.ok{color:#3fe09a}.bad{color:#ff8f6b}.dim{color:#a9a49a}.task{font-style:italic;color:#cfc9bd}.ex{color:#a9a49a;font-size:.78rem}
</style></head><body><main>
<h1>What has actually been asked</h1>
...
<p class="note">Same record as JSON: <a href="/sessions?format=json">/sessions?format=json</a> · <a href="https://brainonbnb.com/registry">Brain Plaza</a></p>
    ...
    if (path === '/lp/windows') {
      ...
      if (wantsHtml && v) {
        ...
        const html = `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>The width record — the liquidity agent</title>
<style>
:root{color-scheme:dark}body{margin:0;background:#0c0b0c;color:#f3efe6;font:15px/1.6 Inter,system-ui,sans-serif}
main{max-width:820px;margin:0 auto;padding:28px 18px 60px}h1{font-size:1.5rem;margin:0 0 4px}h2{font-size:1rem;margin:26px 0 8px;color:#f0b90b}
p.lead{color:#cfc9bd;margin:6px 0 0}a{color:#f0b90b}code{font-size:.85em}
...
<nav class="top"><a href="/lp/agent">&larr; The agent's record</a><a href="https://brainonbnb.com/liquidity">The liquidity page</a><a class="site" href="https://brainonbnb.com/">Dashboard</a></nav>
<h1>The width record</h1>
...
<p class="note">${h(v.earnings_rule || '')}</p></div>
${log.last_error ? `<p class="note">Last cron error ${h(when(log.last_error.at))}: ${h(log.last_error.error)} — a window that could not be measured is skipped, not guessed.</p>` : ''}
