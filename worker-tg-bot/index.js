...
const COMMANDS_VERSION = 'v15-worldcup-final';
...
export function formatGiggleCard(burns, nowMs = Date.now()) {
  ...
  return [
    ...
    `🪙 <b>${total.toFixed(4)} BNB</b>  ·  ${sends.length} send${sends.length === 1 ? '' : 's'}`,
    lastLine,
    '',
...
📊 <b>${burn.percent}%</b> of total supply
