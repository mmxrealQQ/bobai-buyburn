...
${pageTail}`;
    ...
    if (path === '/lp/series') {
      ...
      return json({
        ...
        cadence: 'daily, after the 05:23 UTC run; the range itself is checked every hour, and an hourly check gets a point of its own only when it re-set the position or found one the series did not know',
      }, 200, { 'Cache-Control': 'public, max-age=300' });
    }
