...
const DIR_NOTE = {
  ...
  'worker-lp': 'the DeFi agent — one PancakeSwap V3 position, daily at 04:23 UTC, range checked hourly',
  'worker-tg-bot': 'the Telegram bot: buy and burn alerts, the commands, the daily DeFi card',
  'worker-dev-buyback': 'the creator-fee buyback worker',
  'worker-nft-mint': 'the NFT buy-drop minter',
  'worker-nft-meta': 'the NFT metadata worker',
  'worker-redirect': 'the short links',
  'worker-wc': 'the World Cup tip game, finished and still public',
};
...
hiring, the DeFi agent that runs the project's own liquidity position, and
the token infrastructure that funds it.
...
Plus ${topLevel.length} files at the top level: the token bots as plain Node
scripts, their public audit logs, the manifests, the README and the licence.
