...
async function tradeToRange(pub, send, owner, other, fee, perLWbnb, perLOther, { reserved = 0n, buyLabel = 'buy the missing other side', sellLabel = 'sell the excess of the other side' } = {}) {
  ...
  if (t.side === 'buy') {
    ...
    return swapV3(pub, send, owner, ADDR.WBNB, other, fee, t.amount, (q * 99n) / 100n, t.amount, buyLabel);
  }
  ...
  return swapV3(pub, send, owner, other, ADDR.WBNB, fee, t.amount, (q * 99n) / 100n, q, sellLabel);
}
