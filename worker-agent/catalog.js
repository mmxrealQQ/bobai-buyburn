...
export const CAPABILITIES = {
  free: [
    ...
    { name: 'before a trade: can I get in, can I get out', where: 'https://brainonbnb.com/api/preflight?address=0x...&usd=250 · MCP tool bsc_token_preflight', example: 'https://brainonbnb.com/api/preflight?address=0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82&usd=250', what: 'for any BSC token, at your size: what stops the trade (the sell does not go through from a fresh address, nothing quotes, the round trip loses half), what to weigh — each with its figure and the line it was measured against — then the best route, the slippage it needs and the round trip with the transfer tax measured from executed trades. About 2.5 KB. No "safe" and no score.' },
    ...
    { name: 'look at a V3 position', where: 'https://agent.brainonbnb.com/lp/look?position=<id> or ?address=<wallet>', example: 'https://agent.brainonbnb.com/lp/look?address=0xbFAA69233741924eD5b9d5DAA9B4Bf7B84567F0A', what: 'any PancakeSwap V3 position, read from the chain: in range or not, room to the edges, value, fees owed and whether collecting pays for its gas. The plan — re-set, width, what spare BNB adds — is the paid lp_position_plan' },
