...
window.TEST_DATA = (function () {
  ...
  return {
    ...
    meta: {
      ...
      itemsText: "20 items",
      sources: "Weathers et al. 2013 · Krüger-Gottschalk et al. (German version) 2017 · DSM-5-TR (APA 2022)",
      testPath: "/brainscreener/pcl5",
      retestPath: "/brainscreener/pcl5",
      resultPath: "/brainscreener/pcl5-result",
    },
    ui: {
      question: "Question",
